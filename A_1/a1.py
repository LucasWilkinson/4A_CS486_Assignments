...
class wordNode:
    ...
    This node is to placed into a dictionary using the word concatenated with its part of speech as the key.
    """
    ...
    def addNextWord(self, word, ps, prob):
        """
        This function stores words that follow the node's word and organizes them by parts of speech
        """
